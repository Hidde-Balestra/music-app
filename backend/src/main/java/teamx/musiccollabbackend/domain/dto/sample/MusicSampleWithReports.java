...
public class MusicSampleWithReports {
    ...
    // Default constructor
    public MusicSampleWithReports() {
    }

    // Constructor with MusicSampleModel parameter
    public MusicSampleWithReports(MusicSampleModel musicSample) {
...
//        this.playsObj = musicSample.getPlaysObj();
        this.reports = musicSample.getReports();
    }
    ...
    public void setReports(List<MusicSampleReport> reports) {
